...
// RunModelResp v2
type RunModelResp struct {
	Date1    RunModelRespData     `json:"date1"`
	Date2    RunModelRespData     `json:"date2"`
	Overview RunModelOverviewData `json:"overview"`
}

// RunModelRespData v2
type RunModelRespData struct {
	AbnormalDate []string    `json:"abnormal_date" example:"04/01/2020,05/01/2020,06/01/2020,07/01/2020"`
	DateList     []string    `json:"date_list" example:"01/01/2020,02/01/2020,03/01/2020,04/01/2020,05/01/2020,06/01/2020,07/01/2020"`
	RebuildData  [][]float64 `json:"rebuild_data"`
}

type RunModelOverviewData struct {
	CompareDate2Date1CountOfDiffFeatures []int     `json:"compare_date2_date1_count_of_diff_features"`
	CompareDate2Date1OfDiffFeatures      []float64 `json:"compare_date2_date1_of_diff_features"`
	CompareDate2Date1RateOfDiffFeatures  []float64 `json:"compare_date2_date1_rate_of_diff_features"`
